<div class="container">
    <div class="row">
        <div class="col">
            <img class="img-fluid" 
                 alt="Copertina libro La virtù dell'orto con l'orto sullo sfondo." 
    ...
    <div class="row">
        ...
        <div class="col mt-4 justify-text ">
            ...
            Le riflessioni di Pia Pera sulla pratica del tenere un orto o un giardino (anche se nell'interpretazione di Pia Pera le due cose non sono separate) non sono mai banali.
            L'idea di base è quella della cura di un orto/giardino come <b>momento di benessere</b> e come luogo in cui imparare dalla natura. 
            <br><br>
