<div class="container">
        ...
        <div class="col justify-text">
            ...
            <div class="col-8 offset-2 text-center">
                <img class="img-fluid" 
                     ...
                     src="<?php echo $GLOBALS['base_complete_url']; ?>/img/imgarticles/filastroccaottobre-sm.webp">
                <figcaption>  
    ...
    <div>
       ...
       <h2>Una filastrocca sull'autunno per i più piccini</h2><br>
        ...
        Questa volta un testo dedicato ad ottobre e all'autunno.
       <br><!-- comment -->
